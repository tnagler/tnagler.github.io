---
title: "Publications"
description-meta: "List of papers with links to preprints and published versions."
#page-layout: full
...
Brock and Nagler. **Fast rates for nonstationary weighted risk minimization**.
[[pdf]](https://arxiv.org/abs/2602.05742)
...
Nagler, Kurowicka, Cooke, Joe. **Statistical Dependence Modeling: Festschrift in Honor of Claudia Czado**, Springer  [[doi]](Statistical Dependence Modeling: Festschrift in Honor of Claudia Czado*)

Nagler and Langer. **Optimal neural network approximation of smooth compositional functions on sets with low intrinsic dimension.**
*The 39th Annual Conference on Learning Theory (COLT)* [[pdf]](https://arxiv.org/abs/2602.03539)

Min, Li, Nagler, and Li.  **Mortality forecasting under climate risk: a stochastic approach with distributed lag nonlinear models.** 
*Journal of the Royal Statistical Society Series A: Statistics in Society (to appear)*
[[pdf]](https://arxiv.org/abs/2506.00561) [[doi]](https://academic.oup.com/jrsssa/advance-article/doi/10.1093/jrsssa/qnag082/8724052)

Nagler, Brock, and Palm. **Online bootstrap inference for the trend of nonstationary time series.**
*The 42nd Conference on Uncertainty in Artificial Intelligence (UAI)* [[pdf]](https://arxiv.org/abs/2602.23911)

Nagler, Claeskens, and Gijbels. **On dimension reduction in conditional dependence models.** 
In: *Statistical Dependence Modeling: Festschrift in Honor of Claudia Czado*
[[pdf]](http://arxiv.org/abs/2505.01052) [[doi]](https://link.springer.com/chapter/10.1007/978-3-032-14252-8_8)

Li, Nagler, and Czado. **Modeling cold-related excess deaths via stationary vine copulas.** 
*Scandinavian Actuarial Journal (to appear)*
[[pdf]](files/static/Modelling_cold_related_excess_deaths_by_major_causes_via_stationary_vine_copulas.pdf) [[doi]](https://www.tandfonline.com/doi/full/10.1080/03461238.2026.2650321)
...
**Constructing confidence intervals for 'the' Generalization Error -- a comprehensive benchmark study.** *Data-centric Machine Learning Research (DMLR)* 2(6):1-73, 2025. [[pdf]](https://arxiv.org/abs/2409.18836)

Cheng, Vatter, Nagler, and Chen. **Vine copulas as differentiable computational graphs.**
*Technical report*. [[pdf]](https://arxiv.org/abs/2506.13318)
...
*Annual Review of Statistics and Its Application 9, pp. 453-477* [[doi]](http://www.annualreviews.org/eprint/DMMEJGSBDRJ8NQIM3CVY/full/10.1146/annurev-statistics-040220-101153) [[pdf]](files/static/vine-arisa.pdf)
